...
void InitInventories(int capacity)
{
	...
	inventoryStatus = MemAlloc(capacity * sizeof(*inventoryStatus));
	inventoryData = MemAlloc(capacity * sizeof(*inventoryData));
...
inline int MaxInventories(void)
{
	return inventoryCapacity;
}

inline bool IsInventoryValid(Handle inventory)
{
...
inline int CountInventories(void)
{
