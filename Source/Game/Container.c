...
void InitContainers(int capacity)
{
	...
	containerStatus = MemAlloc(capacity * sizeof(*containerStatus));
	containerData = MemAlloc(capacity * sizeof(*containerData));
...
inline Vector2 GetContainerPosition(Handle container)
{
	return containerData[container.index].position;
}

inline ContainerType GetContainerType(Handle container)
{
	return containerData[container.index].type;
}

inline void SetContainerPosition(Handle container, Vector2 position)
{
	containerData[container.index].position = position;
	SetSpritePosition(containerData[container.index].sprite, position);
}

inline TerminalTile GetCarcassContainerButcheredTile(Handle carcassContainer)
{
	return containerData[carcassContainer.index].value.carcass.butcheredTile;
}

inline int GetCarcassContainerDecayDuration(Handle carcassContainer)
{
	return containerData[carcassContainer.index].value.carcass.decayDuration;
}

inline int GetCarcassContainerDecayTime(Handle carcassContainer)
{
	return containerData[carcassContainer.index].value.carcass.decayTime;
}

inline TerminalTile GetCarcassContainerTile(Handle carcassContainer)
{
	return containerData[carcassContainer.index].value.carcass.tile;
}

inline bool IsCarcassContainerButchered(Handle carcassContainer)
{
	return containerData[carcassContainer.index].value.carcass.butchered;
}

inline void ResetCarcassContainerDecayTime(Handle carcassContainer)
{
...
inline void SetCarcassContainerButchered(Handle carcassContainer, bool butchered)
{
	containerData[carcassContainer.index].value.carcass.butchered = butchered;
}

inline void SetCarcassContainerButcheredTile(Handle carcassContainer, TerminalTile butcheredTile)
{
...
inline void SetCarcassContainerDecayDuration(Handle carcassContainer, int decayDuration)
{
	containerData[carcassContainer.index].value.carcass.decayDuration = decayDuration;
}

inline void SetCarcassContainerTile(Handle carcassContainer, TerminalTile tile)
{
...
inline TerminalTile GetChestContainerClosedTile(Handle chestContainer)
{
	return containerData[chestContainer.index].value.chest.closedTile;
}

inline TerminalTile GetChestContainerOpenedTile(Handle chestContainer)
{
	return containerData[chestContainer.index].value.chest.openedTile;
}

inline bool IsChestContainerOpened(Handle chestContainer)
{
	return containerData[chestContainer.index].value.chest.opened;
}

inline void SetChestContainerClosedTile(Handle chestContainer, TerminalTile closedTile)
{
...
inline void SetChestContainerOpenedTile(Handle chestContainer, TerminalTile openedTile)
{
...
inline int GetLootContainerDecayDuration(Handle lootContainer)
{
	containerData[lootContainer.index].value.loot.decayDuration;
}

inline int GetLootContainerDecayTime(Handle lootContainer)
{
	return containerData[lootContainer.index].value.loot.decayTime;
}

inline TerminalTile GetLootContainerTile(Handle lootContainer)
{
	return containerData[lootContainer.index].value.loot.tile;
}

inline void ResetLootContainerDecayTime(Handle lootContainer)
{
	containerData[lootContainer.index].value.loot.decayTime = containerData[lootContainer.index].value.loot.decayDuration;
}

inline void SetLootContainerDecayDuration(Handle lootContainer, int decayDuration)
{
	containerData[lootContainer.index].value.loot.decayDuration = decayDuration;
}

inline void SetLootContainerTile(Handle lootContainer, TerminalTile tile)
{
